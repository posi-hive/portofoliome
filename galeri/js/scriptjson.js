function tampilAllmenu() {
    ...
    $.getJSON('data/pizza.json', function (hasil) {
        var menu = hasil.menu; //mengeluarkan variabel objek didalam array
        ...
        $.each(menu, function (i, data) {
            ...
            $('#daftar-menu').append('<div class="col-md-4"><div class= "card mb-3"><img class="card-img-top" src="img/menu/' + data.gambar + '" alt = ""><div class="card-body"><h5 class="card-title">' + data.nama + '</h5><p class="card-text">' + data.deskripsi + '</p><h3 class="card-title"><b>Rp. ' + data.harga + '</b></h3><a href="#" class="btn btn-primary">PESAN SEKARANG</a></div></div></div>');
        });
    });
}
    ...
    $.getJSON('data/pizza.json', function (hasil) {
        ...
        $.each(menu, function (i, data) {
            if (data.kategori === kategori.toLowerCase()) {
                content += '<div class="col-md-4"><div class= "card mb-3"><img class="card-img-top" src="img/menu/' + data.gambar + '" alt = ""><div class="card-body"><h5 class="card-title">' + data.nama + '</h5><p class="card-text">' + data.deskripsi + '</p><h3 class="card-title"><b>Rp. ' + data.harga + '</b></h3><a href="#" class="btn btn-primary">PESAN SEKARANG</a></div></div></div>';
            }
        });
