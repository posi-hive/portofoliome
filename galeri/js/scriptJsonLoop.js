function tampilAll() {
    $('#galeri').html('');//fungsi untuk remove ketika dari navigasi lain, tampilin ke awal menu


    // fungsi ambil data json dengan jquery cdn versi javascript
    // Untuk card 
    $.getJSON('data/glry.json', function (hasil) {

        let galri = hasil.galery; //mengeluarkan variabel objek didalam array
        console.log(galri); // untuk melihat hasil di console browser

        // looping card menu makanan
        $.each(galri, function (i, data) {
...
tampilAll(); //panggil semua menu makanan tp harus buat perKategori
